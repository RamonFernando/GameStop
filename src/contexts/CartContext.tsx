...
function computeSlug(game: Game): string {
  // Prefer game.slug if it exists and is not empty, otherwise generate it.
  const anyGame = game as Game & { slug?: string };
  if (anyGame.slug && anyGame.slug.length > 0) {
    return anyGame.slug;
  }
